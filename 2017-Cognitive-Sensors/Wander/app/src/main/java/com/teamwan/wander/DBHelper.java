...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_GS = "CREATE TABLE "
            + GS_TABLE_NAME + "(" + GS_COLUMN_GSID + " INTEGER PRIMARY KEY AUNTOINCREMENT," + GS_COLUMN_PLAYERID
            + " INTEGER," + GS_COLUMN_TIME + " TEXT," + GS_COLUMN_GAMETYPE
            + " TEXT" + ")";

    private static final String CREATE_TABLE_NG = "CREATE TABLE " + NG_TABLE_NAME
            + "(" + NG_COLUMN_GSID + " INTEGER PRIMARY KEY AUTOINCREMENT," + NG_COLUMN_TIME + " TEXT,"
            + NG_COLUMN_RESPONSETIME + " TEXT," + NG_COLUMN_ISGO+ " BOOLEAN,"+ NG_COLUMN_CORRECT+" BOOLEAN,"+ NG_COLUMN_NUMBER
            + "INTEGER" +")";

    private static final String CREATE_TABLE_Q = "CREATE TABLE "
            + Q_TABLE_NAME + "(" + Q_COLUMN_QID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + Q_COLUMN_QUESTION + " TEXT," + Q_COLUMN_TYPE + " TEXT,"
            + Q_COLUMN_MCOPTIONS + " TEXT" + ")";

    private static final String CREATE_TABLE_QA = "CREATE TABLE "
            + QA_TABLE_NAME + "(" + QA_COLUMN_GSID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
    ...
    public boolean updateGameSession(int playerId, String time, String gameType) {
        ...
        contentValues.put(GS_COLUMN_TIME, time);
        contentValues.put(GS_COLUMN_GAMETYPE, gameType);
        db.update(GS_TABLE_NAME, contentValues, GS_COLUMN_GSID +" = ? ", GS_COLUMN_GSID);
        return true;
    }
